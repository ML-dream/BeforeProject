...
public class DaDataCollection {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    final String itemId1="/Nck/Spindle/driveLoad"; 
	    final String itemId2="/Channel/Spindle/driveLoad"; 
...
//	    	  ItemState itemState7 = item7.read(true); 
	    	 ...
	    	 method2("E:\\"+date+".txt", itemState1.getValue()+"   ");
	    	 method2("E:\\"+date+".txt", itemState2.getValue()+"\r\n");
	    	// method2("E:\\"+date+".txt", itemState1.getValue()+"/r/n");
