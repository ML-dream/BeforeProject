...
public class MyReflect {
	 ...
	 *获取非私有的构造函数
	 *
	 *说明：既然根据反射得到了对象，为什么需要invoke？
	 *原因是调用方法也是一样的，一开始不知道哪个方法，也是动态的传递进来字符串才知道具体哪个方法！
	 *还是一样，如果不使用，就要和之前一样用if进行字符串进行判断！
	 */
	...
	public void getPrivateConstructor() throws Exception {
		...
		Person person2 = (Person)con.newInstance("zhangsan");//注意需要强转！！！！
	...
	public void getPrivateMethod() throws Exception {
		...
		Object value = method.invoke(obj);//就是按着顺序给这个对象相应的方法！增加，一开始new出对象
